...
import cn.bluesking.blog.model.entity.Comment;
import cn.bluesking.blog.model.entity.CommentExample;
...
public interface CommentMapper {
	 ...
	 * @return [Comment]查询结果
	 */
	Comment selectByPrimaryKey(@Param("commentNo") Integer commentNo);
